...
int main(int argc, char* argv[])
{
  ...
  cout << dStep << endl;
  double dTargetEnergy = float_input(argc, argv, ++argn, "Target Energy");
  cout << dTargetEnergy << endl;
  ...
  cSpherocyls->y_compress_energy_2p(dTargetEnergy, dResizeRate);
  cSpherocyls->calculate_stress_energy_2p();
  cSpherocyls->display(1,0,0,1);
  //cSpherocyls->save_positions_bin(9999999998);

  //cSpherocyls->cjpr_relax(1e-12, 10, 1000000, 1.0);
  //cSpherocyls->save_positions(9999999999);
  //cSpherocyls->save_positions_bin(9999999999);
